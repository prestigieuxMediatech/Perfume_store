...
const REVIEWS = [
  {
    name: "Ishita M.",
    detail: "Mumbai · Aurum Bespoke No. 03",
    rating: 5,
  ...
  {
    name: "Elena V.",
    detail: "Milan · Aurum Discovery Set",
    rating: 5,
        ...
        <div className="reviews-inner">
          ...
          <header className="reviews-header">
            ...
            <p className="reviews-sub">
              Words from clients who have invited Aurum into their daily
          ...
          <div className="reviews-controls">
            <span className="reviews-stat">
              97% would recommend Aurum to a loved one
            </span>
